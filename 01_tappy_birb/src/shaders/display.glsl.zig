...
pub const VIEW_tex = 1;
pub const SMP_smp = 1;
pub const VsParams = extern struct {
    scale: [2]f32 align(16),
...
//    void main()
//    {
//        gl_Position = vec4((position * vs_params[0].xy) + vs_params[0].zw, 0.0, 1.0);
//        uv = (position + vec2(1.0)) * vec2(0.5);
//    }
//
//
const vs_display_source_glsl410 = [260]u8 {
    ...
    0x6e,0x20,0x2a,0x20,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x30,0x5d,
    0x2e,0x78,0x79,0x29,0x20,0x2b,0x20,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,
    0x5b,0x30,0x5d,0x2e,0x7a,0x77,0x2c,0x20,0x30,0x2e,0x30,0x2c,0x20,0x31,0x2e,0x30,
    0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x28,0x70,0x6f,0x73,
    0x69,0x74,0x69,0x6f,0x6e,0x20,0x2b,0x20,0x76,0x65,0x63,0x32,0x28,0x31,0x2e,0x30,
    0x29,0x29,0x20,0x2a,0x20,0x76,0x65,0x63,0x32,0x28,0x30,0x2e,0x35,0x29,0x3b,0x0a,
    0x7d,0x0a,0x0a,0x00,
};
//
//    #version 410
...
//
//
const vs_display_source_glsl300es = [242]u8 {
    ...
    0x20,0x76,0x65,0x63,0x34,0x28,0x28,0x70,0x6f,0x73,0x69,0x74,0x69,0x6f,0x6e,0x20,
    0x2a,0x20,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x30,0x5d,0x2e,0x78,
    0x79,0x29,0x20,0x2b,0x20,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x30,
    0x5d,0x2e,0x7a,0x77,0x2c,0x20,0x30,0x2e,0x30,0x2c,0x20,0x31,0x2e,0x30,0x29,0x3b,
    0x0a,0x20,0x20,0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x28,0x70,0x6f,0x73,0x69,0x74,
    0x69,0x6f,0x6e,0x20,0x2b,0x20,0x76,0x65,0x63,0x32,0x28,0x31,0x2e,0x30,0x29,0x29,
    0x20,0x2a,0x20,0x76,0x65,0x63,0x32,0x28,0x30,0x2e,0x35,0x29,0x3b,0x0a,0x7d,0x0a,
    0x0a,0x00,
};
//
//    #version 300 es
...
//    {
//        float2 _22_scale : packoffset(c0);
//        float2 _22_offset : packoffset(c0.z);
//    };
//
//
...
//    void vert_main()
//    {
//        gl_Position = float4((position * _22_scale) + _22_offset, 0.0f, 1.0f);
//        uv = (position + 1.0f.xx) * 0.5f.xx;
//    }
//
...
//    }
//
const vs_display_source_hlsl4 = [736]u8 {
    ...
    0x32,0x5f,0x73,0x63,0x61,0x6c,0x65,0x20,0x3a,0x20,0x70,0x61,0x63,0x6b,0x6f,0x66,
    0x66,0x73,0x65,0x74,0x28,0x63,0x30,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x66,0x6c,
    0x6f,0x61,0x74,0x32,0x20,0x5f,0x32,0x32,0x5f,0x6f,0x66,0x66,0x73,0x65,0x74,0x20,
    ...
    0x69,0x74,0x69,0x6f,0x6e,0x20,0x2a,0x20,0x5f,0x32,0x32,0x5f,0x73,0x63,0x61,0x6c,
    0x65,0x29,0x20,0x2b,0x20,0x5f,0x32,0x32,0x5f,0x6f,0x66,0x66,0x73,0x65,0x74,0x2c,
    0x20,0x30,0x2e,0x30,0x66,0x2c,0x20,0x31,0x2e,0x30,0x66,0x29,0x3b,0x0a,0x20,0x20,
    0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x28,0x70,0x6f,0x73,0x69,0x74,0x69,0x6f,0x6e,
    0x20,0x2b,0x20,0x31,0x2e,0x30,0x66,0x2e,0x78,0x78,0x29,0x20,0x2a,0x20,0x30,0x2e,
    0x35,0x66,0x2e,0x78,0x78,0x3b,0x0a,0x7d,0x0a,0x0a,0x53,0x50,0x49,0x52,0x56,0x5f,
...
//    {
//        main0_out out = {};
//        out.gl_Position = float4((in.position * _22.scale) + _22.offset, 0.0, 1.0);
//        out.uv = (in.position + float2(1.0)) * float2(0.5);
//        return out;
//    }
//
//
const vs_display_source_metal_macos = [553]u8 {
    ...
    0x6c,0x6f,0x61,0x74,0x32,0x20,0x73,0x63,0x61,0x6c,0x65,0x3b,0x0a,0x20,0x20,0x20,
    0x20,0x66,0x6c,0x6f,0x61,0x74,0x32,0x20,0x6f,0x66,0x66,0x73,0x65,0x74,0x3b,0x0a,
    ...
    0x5f,0x32,0x32,0x20,0x5b,0x5b,0x62,0x75,0x66,0x66,0x65,0x72,0x28,0x30,0x29,0x5d,
    ...
    0x73,0x69,0x74,0x69,0x6f,0x6e,0x20,0x2a,0x20,0x5f,0x32,0x32,0x2e,0x73,0x63,0x61,
    0x6c,0x65,0x29,0x20,0x2b,0x20,0x5f,0x32,0x32,0x2e,0x6f,0x66,0x66,0x73,0x65,0x74,
...
//
//    fn main_1() {
//      let x_30 = ((position_1 * x_22.scale) + x_22.offset);
//      gl_Position = vec4f(x_30.x, x_30.y, 0.0f, 1.0f);
//      uv = ((position_1 + vec2f(1.0f)) / vec2f(2.0f));
//      return;
//    }
//
//    struct main_out {
...
//    }
//
const vs_display_source_wgsl = [719]u8 {
    ...
    0x20,0x73,0x63,0x61,0x6c,0x65,0x20,0x3a,0x20,0x76,0x65,0x63,0x32,0x66,0x2c,0x0a,
    0x20,0x20,0x2f,0x2a,0x20,0x40,0x6f,0x66,0x66,0x73,0x65,0x74,0x28,0x38,0x29,0x20,
    0x2a,0x2f,0x0a,0x20,0x20,0x6f,0x66,0x66,0x73,0x65,0x74,0x20,0x3a,0x20,0x76,0x65,
    ...
    ,
...
pub fn displayShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    ...
    switch (backend) {
        ...
        .WGPU => {
            ...
            desc.samplers[1].stage = .FRAGMENT;
            desc.samplers[1].sampler_type = .FILTERING;
            desc.samplers[1].wgsl_group1_binding_n = 65;
            desc.texture_sampler_pairs[0].stage = .FRAGMENT;
            desc.texture_sampler_pairs[0].view_slot = 1;
            desc.texture_sampler_pairs[0].sampler_slot = 1;
        },
